...
namespace RiverBooks.OrderProcessing.Data.Migrations
{
    ...
    [Migration("20240618145540_Initial_OrderProcessing")]
            ...
            modelBuilder.Entity("RiverBooks.OrderProcessing.Entities.Order", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("BilligAddress", "RiverBooks.OrderProcessing.Entities.Order.BilligAddress#Address", b1 =>
                        {
                            b1.IsRequired();
