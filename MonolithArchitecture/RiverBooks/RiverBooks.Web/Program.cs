...
builder.Services.AddEmailSendingModuleService(builder.Configuration, logger, mediatRAssemblies);
builder.Services.AddReportingModuleService(builder.Configuration, logger, mediatRAssemblies);
